      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Hey, I&apos;m your new hire. I&apos;m a OceanBase specialized AI expert. In order to get the most out of me,
            I need to know a few things about your database. Complete the task below to give me access to your database
